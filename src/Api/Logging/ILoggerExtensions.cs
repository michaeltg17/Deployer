...
{
    // DeploymentService
    [LoggerMessage(EventId = 1, Level = LogLevel.Information, Message = "Deploying {project}/{environment}.")]
    public static partial void LogDeploying(this ILogger logger, string project, string environment);
    ...
    [LoggerMessage(EventId = 5, Level = LogLevel.Information, Message = "Running docker compose: {composeArgs}.")]
    public static partial void LogRunningCompose(this ILogger logger, string composeArgs);
